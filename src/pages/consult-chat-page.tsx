  ...
  return (
    <>
      <div className="flex justify-center ">
        <div className="mt-8 w-2/5 h-[70vh] flex-col">
          <LiveKitRoom
            className=""
            serverUrl={serverUrl}
            token={token}
          ...
          >
            <div className="flex justify-center bottom-0 h-full ">
              <Chat />
            </div>
          </LiveKitRoom>
